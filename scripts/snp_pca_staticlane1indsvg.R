...
if (!is.na(pops_file)) {
  ...
  clshtml <- c("#812560", "#5ec670", "#a869cf", "#acb839", "#6473db", "#87b144", "#543585", "#d1972c", "#5089d3", "#be8233", "#36dee6", "#c95035", "#48c294", "#c73f7b", "#4b8a49", "#cb69ba", "#668630", "#a083d1", "#c0b55f", "#d0445e", "#a36f35", "#d26e9a", "#86291e")
  clspalette <- colorRampPalette(clshtml)(23)
